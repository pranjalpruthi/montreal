    ...
    <div className="container mx-auto px-4 py-12 pt-24">
      ...
      <main className="max-w-4xl mx-auto">
        <Section title="Introduction" emoji="👋">
          <p>
            These terms and conditions outline the rules and regulations for the use of ISKM Montreal’s
            Website, located at{' '}
          ...
          <p>
            ...
            ISKM Montreal if you do not agree to take all of the terms and conditions stated on this page.
          </p>
          <p>
            ...
            “Our”, and “Us” refers to our Company, ISKM Montreal. “Party”, “Parties”, or “Us” refers to both
            ...
            stated services, in accordance with and subject to, the prevailing laws of Canada. Any use of the
        ...
        <Section title="Cookies" emoji="🍪">
          <p>
            We employ the use of cookies. By accessing ISKM Montreal, you agreed to use cookies in agreement
            with ISKM Montreal’s Privacy Policy.
          </p>
          <p>
        ...
        <Section title="License" emoji="📜">
          <p>
            Unless otherwise stated, ISKM Montreal and/or its licensors own the intellectual property rights
            for all material on ISKM Montreal. All intellectual property rights are reserved. You may access
            this from ISKM Montreal for your own personal use subjected to restrictions set in these Terms
            and Conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc list-inside space-y-2 mt-4">
            <li>Republish material from ISKM Montreal</li>
            <li>Sell, rent, or sub-license material from ISKM Montreal</li>
            <li>Reproduce, duplicate or copy material from ISKM Montreal</li>
            <li>Redistribute content from ISKM Montreal</li>
          </ul>
        </Section>
        ...
        <Section title="Hyperlinking to our Content" emoji="🔗">
          ...
          <p className="mt-4">
            ...
            compensates the absence of ISKM Montreal; and (d) the link is in the context of general resource
            information.
          </p>
          <p className="mt-4">
          ...
          <p className="mt-4">
            No use of ISKM Montreal’s logo or other artwork will be allowed for linking absent a trademark
            license agreement.
          </p>
        </Section>
        ...
        <Section title="Donations" emoji="💖">
            ...
            <p>
                In exceptional circumstances, a refund may be considered. For more details on such cases, please refer to our <Link to="/legal/returns" className="text-blue-600 hover:underline">Refund and Cancellation Policy</Link>.
            </p>
        </Section>
        ...
        <Section title="Your Privacy" emoji="🔒">
          <p>
            Please read our <Link to="/legal/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>.
          </p>
        </Section>
